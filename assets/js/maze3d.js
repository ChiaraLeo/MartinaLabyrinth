(function () {
  ...
  function initializeEngine() {
    ...
    const light = new THREE.AmbientLight(
      0x858585,
      levelHelper && levelHelper.current === 3 ? 1 : 0
    ); // soft white light
    scene.add(light);
    ...
    message.innerHTML =
      "Use Up/Down/Left/Right arrows or the virtual pad to move and rotate the camera";
  ...
  function initializeScene(level) {
    ...
    var ground = new THREE.Mesh(
      ...
      new THREE.MeshPhongMaterial({
        map: loader.load(`assets/images/textures${level}/ground_diffuse.jpg`),
      })
    );
    ...
    var topMesh = new THREE.Mesh(
      floorGeometry,
      new THREE.MeshPhongMaterial({
        map: loader.load(`assets/images/textures${level}/roof_diffuse.jpg`),
      })
    );
    ...
    var wallMaterial = new THREE.MeshPhongMaterial({
      map: loader.load(`assets/images/textures${level}/wall_diffuse.jpg`),
    });
  ...
  function endScreen() {
    console.log(levelHelper, levelHelper.current, "CURRENT");
